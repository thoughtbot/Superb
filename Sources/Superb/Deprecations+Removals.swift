...
public extension RequestAuthorizer {
  ...
  convenience init<Provider: AuthenticationProvider, Storage: TokenStorage>(
    authorizationProvider: Provider,
    tokenStorage: Storage,
    applicationDelegate: @autoclosure @escaping () -> UIApplicationDelegate? = nil,
...
public extension RequestAuthorizer where Token: KeychainDecodable & KeychainEncodable {
  ...
  convenience init<Provider: AuthenticationProvider>(
    authorizationProvider: Provider,
    applicationDelegate: @autoclosure @escaping () -> UIApplicationDelegate? = nil,
    urlSession: URLSession = .shared
